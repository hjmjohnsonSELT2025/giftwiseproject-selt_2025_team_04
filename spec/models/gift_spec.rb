...
RSpec.describe Gift, type: :model do
  it "should add gifts" do
    @gift = Gift.new({:name => "test1", :description => "test gift", :price => 15.6, :user_id => User.find_by(:email => "a@b.c").id, :recipient_id => Recipient.find_by(:name => "test recipient").id, :event_id => nil, :visibility => 0})
